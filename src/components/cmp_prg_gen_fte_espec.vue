<template>
    <v-container fluid>
        <v-layout>
            <v-flex xs4 class="pr-2">
                <v-select
                    ...
                    outlined
                    dense
                    @change="get_ejec_prg_gen_fte_espec()"
                  >
                  </v-select>
        ...
        <v-layout class="elevation-1 pa-2">
          <v-flex>
            <spam class="text-h5 font-weight-light">% de Ejecución por Meta/Clasificador</spam>
          </v-flex>
        </v-layout>
      ...
      <script>
        ...
        export default {
          ...
          mounted(){
            ...
            this.get_ejec_prg_gen_fte_espec();
          ...
          methods:{
            ...
            async get_ejec_prg_gen_fte_espec(){
                try {
                    this.ds_siaf=[];
                    let datos=await axios.get(url+'ejec_prg_gen_fte_espec/'+this.cod_prg+"/"+this.cod_gen+"/"+this.cod_fte)
                    this.ds_siaf= await datos.data;
                } catch (error) {
                    console.log(error);
                }
