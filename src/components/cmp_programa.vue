      ...
      <script>
        ...
        export default {
          ...
          methods:{
            ...
            async get_totales_programa(){
                try {
                    let datos=await axios.get(url+'totales_programa/'+this.cod_prg)
                    this.ds_tot= await datos.data;
                } catch (error) {
                    console.log(error);
                }
            },
            async get_ejec_fuente_programa(){
                try {
                    let datos=await axios.get(url+'ejec_fuente_programa/'+this.cod_prg)
            ...
            async get_ejec_generica_programa(){
                try {
                    let datos=await axios.get(url+'ejec_generica_programa/'+this.cod_prg)
